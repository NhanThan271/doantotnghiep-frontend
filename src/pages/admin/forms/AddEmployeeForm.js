...
export default function AddEmployeeForm({ closeForm, onSave }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            // Nếu có ảnh được chọn, gửi file
            if (formData.image) {
                formDataToSend.append('image', formData.image);
            }
            // Nếu không có ảnh nhưng có imageUrl, gửi imageUrl
            ...
            if (!response.ok) {
                ...
                throw new Error(errorText || 'Thêm nhân viên thất bại');
            }
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div style={{ marginBottom: '20px' }}>
                        ...
                        <p style={{ fontSize: '12px', color: 'var(--color-text-secondary)', margin: '4px 0 0 0' }}>
                            Tối thiểu 3 ký tự, không có khoảng trắng
                        </p>
                    </div>
                    ...
                    <div style={{ marginBottom: '20px' }}>
                        <label style={{
                            ...
                            border: '1px solid var(--color-border)',
                            borderRadius: '10px',
                            background: formData.isActive ? 'rgba(139, 92, 246, 0.05)' : 'transparent',
                            transition: 'all 0.2s'
                        }}>
                            <input
                                type="checkbox"
