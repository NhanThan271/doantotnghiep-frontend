...
function SeatTab({ branchId, onSelectSeat, toast }) {
    ...
    const fetchTables = useCallback(async () => {
        ...
        } catch (e) { toast.add('error', 'Lỗi', 'Không thể tải danh sách bàn'); }
    ...
    const fetchRooms = useCallback(async () => {
        ...
        try {
            ...
            toast.add('error', 'Lỗi', 'Không thể tải danh sách phòng');
        } finally {
            setLoading(false);
        }
    }, [branchId]);
...
function OrdersTab({ branchId, toast }) {
    ...
    const fetchOrders = useCallback(async () => {
        ...
        } catch (e) { toast.add('error', 'Lỗi', 'Không thể tải đơn hàng'); }
        finally { setLoading(false); }
    }, [branchId]);
    ...
    const doAction = async (id, endpoint, method = 'PUT') => {
        ...
        } catch (e) { toast.add('error', 'Lỗi', 'Thao tác thất bại'); }
    ...
    const addItemsToOrder = async (orderId) => {
        ...
        try {
            ...
            fetchOrders();
        } catch (e) { toast.add('error', 'Lỗi', 'Không thể thêm món'); }
    };
